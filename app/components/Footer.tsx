...
const LastSection = (
    <div className="flex flex-col sm:flex-row sm:mt-12 mx-auto max-w-[50rem] p-6 sm:justify-between items-start">
      ...
      <div className="mb-8   hidden sm:block text-[0.8rem] sm:mb-0">
        <ul className="flex flex-col gap-y-2">
          <li className=" font-medium font2 text-sm">services</li>
          <li>Kitchen</li>
          <li>living room</li>
          <li>bathroom</li>
          <li>dressing hall</li>
      ...
      <div className="flex sm:hidden w-full mt-12  mb-6 justify-around items-start">
         {/* Second Division */}
      <div className="sm:hidden  text-[0.8rem] sm:mb-0">
        <ul className="flex flex-col  items-start gap-y-2">
          <li className=" ml-3 font-medium font2 text-sm ">page links</li>
          <a href="about.html" className="hover:bg-gray-900 text-black rounded-md px-3 py-2 font-medium mt-2 hover:text-white" aria-current="page">about us</a>
          <a href="project.html" className="text-black hover:bg-gray-700 hover:text-white rounded-md px-3 py-2  font-medium">projects</a>
          <a href="team.html" className="text-black hover:bg-gray-700 hover:text-white rounded-md px-3 py-2  font-medium">our team</a>
          <a href="faq.html" className="text-black hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 font-medium">faq's</a>
      ...
      {/* Fourth Division */}
      <div className=" text-[0.8rem] mb-8">
        <h2 className="text-sm font-medium font2 mb-4">Contact</h2>
  ...
  <div className=" sm:hidden">
        ...
        <p className="text-gray-800 mt-4 mb-4 w-1/2 text-[0.8rem] text-left sm:text-left">it is a long established fact that a reader will be distracted lookings </p>
