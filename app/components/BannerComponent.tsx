...
const YourComponent = () => {
  ...
  const project =  (
      <div className="-mt-10 sm:mt-16 grid grid-cols-1 mx-auto max-w-[50rem] md:grid-cols-3 gap-8 p-8 text-center">
        {/* Division One */}
        <div className="flex flex-col items-center bg-white sm:px-6 sm:py-20 py-6 mx-12  border-x slate-900 sm:mx-0 lg:mx-0 rounded-lg shadow-lg  justify-center transform transition-transform hover:scale-105">
        ...
        {/* Division Three */}
        <div className="flex flex-col items-center bg-white sm:px-6 sm:py-20 py-6 mx-12 sm:mx-0  border-x slate-900  lg:mx-0 rounded-lg shadow-lg  justify-center transform transition-transform hover:scale-105">
