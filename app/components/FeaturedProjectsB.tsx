// components/FeaturedProjectsB.tsx
  ...
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-50 to-white">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Filter Tabs - Optional for future enhancement */}
        <div className="flex flex-wrap justify-center gap-2 mb-12">
          {['All Projects', 'Kitchen', 'Living Room', 'Bedroom', 'Bathroom', 'Office'].map((category) => (
            <button
              key={category}
        ...
        {/* Uniform Grid - Info Reveals on Hover */}
          ...
          {projects.map((project) => (
            ...
            >
                ...
                <div className="relative h-64 overflow-hidden">
                  ...
                  {/* Category & Budget - Always Visible */}
                  <div className="absolute top-4 left-4 right-4 flex justify-between items-start">
                    <span className="bg-gray-900 text-white text-xs px-3 py-1 rounded-full font-medium">
                      {project.type}
                    </span>
                    <span className="bg-white/90 text-gray-900 text-sm px-3 py-1 rounded-full font-medium backdrop-blur-sm">
                      {project.budget}
                    </span>
                  </div>
                </div>
                ...
                {/* Detailed Overlay - Reveals on Hover */}
                <div className={`
                  absolute inset-0 bg-black/50 backdrop-blur-sm 
                  flex items-center justify-center p-6
                  transition-all duration-300 ease-out z-1
...
export default FeaturedProjectsB;