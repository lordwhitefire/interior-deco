...
const JoinUsSection = () => {
  return (
    <div className="max-w-[50rem] sm:mx-auto  mx-4 p-6 bg-customColor3 rounded-3xl sm:rounded-6xl sm:py-8 sm:flex sm:flex-col sm:justify-center sm:items-center">
      ...
      <button className="mt-2 w-[8rem] sm:w-[8rem] text-[0.8rem] sm:text-sm flex gap-x-2 items-center bg-customColor2 hover:bg-blue-700 text-white font-bold py-3 sm:py-4 sm:pl-4 pl-4 rounded-md sm:rounded-md">
        Contact Us 
